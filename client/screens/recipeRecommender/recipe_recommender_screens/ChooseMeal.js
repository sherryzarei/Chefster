...
import { Text, View, TouchableOpacity, StyleSheet, ScrollView, TextInput, KeyboardAvoidingView, Platform, Keyboard, TouchableWithoutFeedback, SafeAreaView } from 'react-native';
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <ScrollView contentContainerStyle={styles.contentContainer}>
                        ...
                        <TouchableOpacity style={[styles.button, { marginBottom: 50 }]} onPress={() => navigation.navigate('RecipeNavigator', { screen: 'ChooseIngredients' })}>
