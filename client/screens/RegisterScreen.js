...
export default function RegisterScreen({ navigation }) {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            const response = await axios.post("http://192.168.0.132:8100/register", formData, {
                headers: {
            ...
            <KeyboardAvoidingView>
                <ScrollView>
                    ...
                    <View style={{ marginTop: 30 }}>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 17 }}>Full Name</Text>
                        <TextInput
                    ...
                    <View style={{ marginTop: 30 }}>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 17 }}>Photo</Text>
                        <TouchableOpacity
                            style={styles.button}
                            onPress={takePhoto}
                        >
                            <Text style={{ color: 'gray', fontWeight: 'bold' }}>Take a photo</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={styles.button}
                            onPress={pickImage} // Button for selecting image from gallery
                        >
                            <Text style={{ color: 'gray', fontWeight: 'bold' }}>Choose from Gallery</Text>
                        </TouchableOpacity>
                        {image ? (
                            <Image
                                source={{ uri: image }}
                    ...
                    <Pressable onPress={() => navigation.navigate('Login')}>
                        <Text style={styles.loginText}>
                            Already have an account? <Text style={{ color: 'red', fontWeight: 'bold' }}>Sign In</Text>
                        </Text>
                    </Pressable>
                </ScrollView>
            </KeyboardAvoidingView>
