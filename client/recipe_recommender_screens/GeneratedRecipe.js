...
export default function GeneratedRecipe({ navigation, route }) {
    ...
    // Accept handler: navigates to Accepted Recipe screen and removes the top card.
    ...
    // Reject handler: removes the top card and stores it in rejectedRecipes.
                    ...
                    <ScrollView contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false}>
                        <View style={styles.container}>
                            ...
                            <View style={styles.buttonWrapper}>
                                ...
                                <TouchableOpacity
                                    style={styles.button}
                                    onPress={() => handleAcceptRecipe(topRecipe)}
                                >
...
const styles = StyleSheet.create({
    ...
    button: { backgroundColor: 'black', padding: 10, borderRadius: 40, alignItems: 'center', width: '25%', zIndex: 2 },
